...
public class CharacterPane extends ScrollPane {
    ...
    private Pane getDetailedPane() {
        ...
        if (this.character != null) {
            ...
            mainImage.setImage(new Image(Launcher.class.getResource(
        ...
        characterInfoPane.getChildren().addAll(name, mainImage, hp, type, atk, def, res, genCharacter);
        return characterInfoPane;
    }

    public void drawPane(BasedCharacter character) {
        this.character = character;
        Pane characterInfo = getDetailedPane();
